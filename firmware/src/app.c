...
// CNPUCbits.CNPUC4 = 1; /* 2018 */
    ...
    SYS_PORTS_PinDirectionSelect(PORTS_ID_0, SYS_PORTS_DIRECTION_INPUT, PORT_CHANNEL_C, PORTS_BIT_POS_4);  // 2018 button
    ...
    CNPUAbits.CNPUA1 = 1; // RA1 pullup == on
